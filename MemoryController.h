...
public:
    ...
    void SetRwSyncHint(bool valid, uint8_t target_group, unsigned master_read_cnt,
            unsigned master_write_cnt, unsigned master_qsize);
...
//    Rmw *rmw;
    ...
    unsigned rw_sync_master_read_cnt;
    unsigned rw_sync_master_write_cnt;
    unsigned rw_sync_master_qsize;
...
public:
    ...
    bool can_follow_rw_sync(uint8_t target_group, bool has_read_cmd,
            bool has_write_cmd, bool high_qos_trig);
    void apply_rw_sync_hint(bool has_read_cmd, bool has_write_cmd,
            bool high_qos_trig);
